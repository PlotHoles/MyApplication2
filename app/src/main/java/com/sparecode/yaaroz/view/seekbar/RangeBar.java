...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.drawable.setting_sel_round;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.drawable.setting_sel_round;
