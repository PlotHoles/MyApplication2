package com.sparecode.yaaroz.view.seekbar;
...
import com.sparecode.yaaroz.view.seekbar.util.BitmapUtil;
import com.sparecode.yaaroz.view.seekbar.util.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
     ...
     */
    public static final int ACTIVE_COLOR = Color.parseColor("#0074E4");
    /**
    ...
    private boolean showLablesAtBottom;
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.setting_sel_round;
        int thumbPressed = R.drawable.setting_sel_round;
        int thumbDisabled = R.drawable.setting_sel_round;
        ...
        if (attrs == null) {
            ...
            defaultColor = Color.parseColor("#0074E4");
            alwaysActive = false;
            showTextAboveThumbs = true;
            textAboveThumbsColor = Color.parseColor("#0074E4");
            ...
            try {
                ...
                textAboveThumbsColor = a.getColor(R.styleable.RangeSeekBar_textAboveThumbsColor, Color.parseColor("#0074E4"));
                ...
                defaultColor = a.getColor(R.styleable.RangeSeekBar_defaultColor, Color.parseColor("#0074E4"));
