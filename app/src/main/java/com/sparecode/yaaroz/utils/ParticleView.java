package com.sparecode.yaaroz.utils;
...
public class ParticleView extends View {
    ...
    private void initView(AttributeSet attrs) {
        ...
        mParticleTextPaint.setColor(Color.parseColor("#FFFFFF"));
        mHostTextPaint.setColor(mBgColor);
        //Typeface font = Typeface.createFromAsset(getContext().getAssets(), "TrajanPro-Regular.ttf");
        //mHostTextPaint.setTypeface(font);
